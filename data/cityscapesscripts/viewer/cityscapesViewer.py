...
from data.cityscapesscripts.helpers.annotation import CsObjectType, Annotation
from data.cityscapesscripts.helpers.labels import name2label, assureSingleInstanceName
from data.cityscapesscripts.helpers.labels_cityPersons import name2labelCp
...
class CityscapesViewer(QtGui.QMainWindow):
    ...
    def drawZoom(self, qp, overlay):
        ...
        if overlay:
            ...
            overlay_scaled = QtGui.QImage(self.image.width(), self.image.height(),
